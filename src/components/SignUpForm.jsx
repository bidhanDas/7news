    ...
    <div className="row justify-content-center mt-4">
        <div className="col-md-8 col-lg-8 col-sm-12 col-12">
            <div className="card p-5">
                <div className="row ">
                    <h5 className="mb-1 mx-0 px-0">User Registration</h5> {/* dafault margin padding thake */}
                ...
                <div className="row">
                    <div className="col-md-4 col-lg-4 col-sm-12 p-1 col-12">
                        {
                          !submit &&
                          <button onClick={handleSubmit} className="btn btn-danger mt-3 w-100">Sign Up</button>
                        }
